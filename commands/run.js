...
exports.tip = '*run* {variable} - Interpreta el valor de una variable como si fuera un comando.';
...
exports.exec = (input, data) => {
    ...
    return new Promise((resolve) => {
        s3.getObject({
            ...
            index.run(data.text, data, resolve);
        }).catch((err) => {
            resolve("Oops, parece que tal variable no existe");
        });
    });
